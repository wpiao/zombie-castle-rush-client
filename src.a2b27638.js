...
},{"./url":"node_modules/socket.io-client/build/url.js","./manager":"node_modules/socket.io-client/build/manager.js","debug":"node_modules/debug/src/browser.js","socket.io-parser":"node_modules/socket.io-parser/dist/index.js","./socket":"node_modules/socket.io-client/build/socket.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var serverAddress = "https://zombie-castle-rush-server.herokuapp.com/";
...
function connectToSocket(serverAddress) {
  return new Promise(function (res) {
    var socket = (0, _socket.io)(serverAddress);
    res(socket);
  });
}
...
function start() {
  connectToSocket(serverAddress).then(function (socket) {
    var terminal = startTerminal(container, socket);
...
start();
},{"./TerminalUI":"src/TerminalUI.js","socket.io-client":"node_modules/socket.io-client/build/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
